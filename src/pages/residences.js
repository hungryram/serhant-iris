    ...
    return (
        <Layout>
            ...
            <Intro
                ...
                body="Available in spacious half and full-floor studio to 3-bedroom layouts, each of 
            ...
            <Intro
                ...
                body="Wide plank European red oak floors shine in steady streams in northern and 
                ...
                gardening, and easy warm-weather lounging."
            />
            ...
            <Intro
                heading="Kitchens"
                body="Accessible and luxurious, kitchens are equipped with custom desert oak 
            ...
            <Intro
                ...
                body="Quiet, spacious, and situated away from living areas, primary bedrooms at 
                ...
                options at your fingertips. Master bedrooms have their own additional private balcony"
            />
            ...
            <Intro
                heading="Primary Bathrooms"
                body="Polished Onyx porcelain slab walls imported from Italy and radiant heated 
                ...
                hydronic towel warmers are the ideal accents to glass-enclosed centerpiece wet rooms with slatted teak floors, a rain showerhead with handheld shower wand, and a freestanding Wetstyle soaking tub."
            />
        </Layout>
    )
}